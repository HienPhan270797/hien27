...
<div class="box box-warning">
	<div class="box-header">
		<h3 class="box-title">Danh sách Hàng bảo hành đã nhận về</h3>
	...
	<!-- /.box-header -->
	<div class="box-body">
		<table id="table_danhanve" class="table table-bordered table-striped table-hover">
			<thead>
				<tr>
					<th>Tên SP</th>
					<th>Mô tả lỗi</th>
			...
			<tbody>
				@foreach($receipted_warcard_list as $wc)
				<tr>
